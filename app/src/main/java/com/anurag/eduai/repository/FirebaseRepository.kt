    ...
    suspend fun checkUserExists(userId: String): UserCheckResult {
        return try {
            ...
            if (userId.isBlank()) {
                ...
                return UserCheckResult.Error(kotlin.IllegalArgumentException("User ID cannot be empty"))
            }
            ...
            if (!snapshot.exists()) {
                ...
                if (user != null) {
                    ...
                    UserCheckResult.Error(kotlin.Exception("Failed to parse user data"))
                }
            }
    ...
    suspend fun createNewUser(user: User): Boolean {
        return try {
            ...
            if (user.id.isBlank()) {
                ...
                throw kotlin.IllegalArgumentException("User ID cannot be empty")
            }
