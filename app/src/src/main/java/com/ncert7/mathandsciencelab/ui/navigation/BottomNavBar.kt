        ...
        NavHost(
            ...
            composable(BottomNavItem.Home.route) {
                HomeScreen(
                    ...
                    // Home screen shortcut: no subject/chapter context available, pass empty strings
            ...
            composable("concepts/{chapterId}/{type}") { backStackEntry ->
                ...
                ConceptScreen(
                    ...
                    onSimulationClick = { title, url, conceptId, subjectName, chapterName ->
                        ...
                        navController.navigate("concept_sim_view/$encodedUrl/$encodedTitle/$conceptId/$encodedSubject/$encodedChapter")
                    },
                    onGoHome = {
                        navController.navigate("home") {
                            popUpTo(navController.graph.startDestinationId) { inclusive = true }
            ...
            composable(
                route = "concept_sim_view/{url}/{title}/{conceptId}/{subjectName}/{chapterName}",
                arguments = listOf(
